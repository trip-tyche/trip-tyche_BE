package com.triptyche.backend.domain.trip.facade;
...
public class TripFacade {
  ...
  public TripMapResponse getTripInfoById(User user, String tripKey) {
    ...
    List<MediaFileResponse> mediaFiles = pinPointRepository.findMediaFilesByTripId(
            trip.getTripId(), DEFAULT_INVALID_DATE);
  ...
  public PinPointMediaListResponse getPointImages(User user, String tripKey, Long pinPointId) {
    ...
    return new PinPointMediaListResponse(pinPoint.getPinPointId(), mediaFiles);
  }
