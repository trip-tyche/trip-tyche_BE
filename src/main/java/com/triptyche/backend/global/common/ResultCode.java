...
public enum ResultCode {
  ...
  // 공통 오류 코드 (1000번대)
  // JSON 파싱 오류, 타입 불일치 등 요청 자체가 잘못된 경우
  ...
  OAUTH_SERVICE_FAILURE(HttpStatus.INTERNAL_SERVER_ERROR, 2001, "OAuth 서비스 연동에 실패했습니다."),
  ...
  JWT_CLAIM_ERROR(HttpStatus.UNAUTHORIZED, 2004, "토큰에서 정보를 추출하는 데 실패했습니다."),
  JWT_PARSING_ERROR(HttpStatus.UNAUTHORIZED, 2005, "토큰 파싱 중 오류가 발생했습니다."),
  ...
  DATA_NOT_FOUND(HttpStatus.NOT_FOUND, 7000, "해당 위치 정보를 찾을 수 없습니다."),
